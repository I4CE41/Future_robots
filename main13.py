...
def run_mission(args):
    ...
    escape_anchor = None          # (x, y) of the current repeated-escape cluster
    escape_anchor_count = 0       # escapes near that anchor
    escape_loop_limit = 4         # trips -> force wide reroute
