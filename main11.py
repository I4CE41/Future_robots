"""main11.py -- corridor-aware robot rescue benchmark.
...
from robot_rescue.control.main11_helpers.nmpc_controller import NMPCController
from robot_rescue.control.main11_helpers.safety import SafetyFilter
from robot_rescue.control.main11_helpers.main3_helpers.shims import apply_shims
from robot_rescue.control.main11_helpers.main3_helpers.dynamic_tracker import DynamicTracker
from robot_rescue.control.main11_helpers.main3_helpers.world_aware_astar import WorldAwareAStar
from robot_rescue.control.main11_helpers.main3_helpers.energy_paper import PhysicsEnergyManager
from robot_rescue.control.main11_helpers.main3_helpers.perception_fusion import PerceptionFusion
from robot_rescue.control.main11_helpers.main3_helpers.path_clearance import (
    CorridorPredictor,
...
from robot_rescue.control.main11_helpers.main3_helpers.corridor_geometry import (
...
def run_mission(args):
    ...
    if getattr(args, "reset_path_memory", False):
        ...
        print(f"[main11] reset path memory: {PATH_MEMORY_FILE}")
...
def print_summary(m):
    print("\n" + "=" * 60)
    print(" Chapter-4 Warehouse Mission Summary (main11)")
    print("=" * 60)
...
def run_batch(args):
    ...
    print("\n" + "=" * 64)
    print(f" main11 batch: variant={args.variant}  {len(ok)}/{n} success "
...
def parse_args():
    ap = argparse.ArgumentParser(description="main11 corridor-aware benchmark")
    ...
    ap.add_argument("--batch-out", type=str, default="main11_batch.csv")
